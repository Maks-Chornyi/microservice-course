package com.makschornyi.currencyconvertionservice.model;
...
public class CurrencyConversionBean {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CurrencyConversionBean)) return false;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(from, to, conversionMultiple, quantity, totalCalculatedAmount, port);
    }
